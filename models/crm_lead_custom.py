...
class Crmlead(models.Model):
    ...
    code_potential = fields.Selection(related="partner_id.code_potential", store=True)
    code_adoption = fields.Selection(related="partner_id.code_adoption", store=True)
    code_solvency = fields.Selection(related="partner_id.code_solvency", store=True)
    ...
    code_category = fields.Many2one('customer.category', related="partner_id.code_category", store=True)
